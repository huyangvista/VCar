...
public class CurrContest {
	...
	public void ConvertResultSet(ResultSet rs, CurrContest entity) throws DBException {
		try {
			Util util = new Util();
			while (rs.next()) {
	 ...
	 * @return the vsState
	 */
	public String getVsState()
	{
		return vsState;
	}

	/**
	 * @param vsState the vsState to set
	 */
	public void setVsState(String vsState)
	{

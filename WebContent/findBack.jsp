...
<table style="border-style:dashed;border-width:1px; border-color:#f66;" bordercolor="#f66" width="960" height="360" cellpadding="0" cellspacing="0" align="center" >
  <tr>
    <td width="440">
      ...
      <form  method="post" name="AlterForm" id="AlterForm" action="zlpc/findBack" onsubmit="javascript:return checkForm()" >
    	  <table align="center" width="340" border="0" height="174" cellpadding="0" cellspacing="0">
    	    <tr>
    	      <td height="26" colspan="3"><font size="+2" color="#f66"><b>　　　　重置密码</b></font></td>
   	        </tr>
    	    <tr>
    ...
    <td width="518">
    	<font size="-1" color="#777777">成为有二手车交易网的会员，您才能竞拍到您看中的车辆，若您还没有二手车交易网的账号，请先<a href="register"><font size="+1"><b>注册</b></font></a>账号。</font>
    </td>
  </tr>
</table>
</div>

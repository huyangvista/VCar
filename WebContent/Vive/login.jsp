...
<div style="width:960px;height:400px;margin:0 auto; margin-left:180px;">
	<hr style="border: 1px dashed #F55" />
	<table
			style="border-style:dashed;border-width:1px; border-color:#F55;"
			bordercolor="#F55" width="960" height="360" cellpadding="0"
			cellspacing="0" align="center">
		<tr>
			<td width="440">
				<div style="border: 1px solid #F55;width:350px;height:250px;">
					<form method="post" name="loginForm2"
						...
						<table align="center" width="340" border="0" height="220"
							...
							<tr>
								<td height="26" colspan="3"><font size="+2" color="#F55"><b>　　　　　会员登录</b> </font>
								</td>
							</tr>
							<tr>

...
<body>
	...
	<div class="container" style="margin-left: 180px; clear: both;">
		<c:if test="${sessionScope.user == null }">
			<form method="post" name="loginForm2" action="zlpc/login"
	...
	<div style="height: 170px;">
		<div
			style="width: 700px; height: 170px; margin-left: 180px; border: 2px solid #f66; float: left;"
			class="diva">
			<a href="#"><img src="img/auction-flow2.png"
					...
					<ul>
						<c:forEach var="notice" items="${requestScope.list}">
							<li><div class="test_demo_ellipsis">
									<font size="+1"><a href="notice/${notice.n_id }.html"
										tppabs="#" target="_blank" title="${notice.title}">
											${notice.title}</a></font> <strong> 【<span class="date"
										style="font-size: 10px"><fmt:formatDate
									...
									<td align="center" valign="center" width="245">
										<div id="xpp">
											<a href="javascript:void(0)" rel="freezeUsers-24253"
												...
												alt="查看会员" src="img/shppcar.png" /> <font id="appCount${entry.v_id }" color="#F00" >${entry.attCout}</font></a>
										</div>
										<div>
											<a
												href="javascript:setRequest('${sessionScope.user.u_id }','${entry.v_id}','state' , '0' , '${entry.attCout}')"
												class="indexchk"> <strong>登记</strong> </a> <a

...
<body>
	<center>
		<h2>
			<font color="#FF0000"> 佣金比例和购买低价设定 </font>
		</h2>
	</center>
				...
				<table class="table table-hover" border="1">
					<thead>
						<tr>
							...
							<td width="12%"><div align="center">购买限额</div></td>
							<td width="12%"><div align="center">购买佣金比例</div></td>

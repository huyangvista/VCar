...
<%
	...
	if (info != null) out.println("<script type='text/javascript'> alert('" + info.get(0) + "');</script>");
%>
</head>
<body>
	<center>
		<h2>
			<font color="#FF0000"> 添加车辆信息</font>
		</h2>
	</center>
					...
					<table class="table table-hover" border="0">
						<tbody>
							...
							<tr>
								...
								<td><input type="text" class="input" name="regTime" onclick="MyCalendar.SetDate(this)" /></td>
								<td>保证金：</td>
								<td><input type="text" class="input" name="pledge" /></td>
							</tr>
							<tr>
								<td>是否过户：</td>

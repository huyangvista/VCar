...
<body>
	<div class="main-container" id="main-container">
		...
		<ul class="nav nav-list">
					...
					<li>
						<div align="center">
							<a href="QueryServlet?view=ContestApply" target="mainFrame"> <i
								class="icon-edit"></i> <span class="menu-text"><strong>批准购买申请</strong>
							</span> </a>
						</div>
					</li>
					<li></li>
			...
			<li><a> <i class="icon-user"></i> <span class="menu-text">出售管理</span>
			</a>
				<ul class="nav nav-list " style="display:none" id="paimai">
					<li>
						<div align="center">
							<a href="QueryServlet?view=AuctionTimeSetting" target="mainFrame"> <i
								class="icon-plus"></i> <span class="menu-text"><strong>出售与时间设定</strong>
							</span> </a>
						</div>
					</li>
					<li></li>
					<li>
						<div align="center">
							<a href="QueryServlet?view=StartContest" target="mainFrame"> <i
								class="icon-plus"></i> <span class="menu-text"><strong>终止销售</strong>
							</span> </a>
						</div>
					</li>
					<li>
			...
			<li><a> <i class="icon-list-alt"></i> <span
				...
				<ul class="nav nav-list" style="display:none" id="zhongbiao">
					...
					<li>
						<div align="center">
							<a href="QueryServlet?view=SucInforFinish" target="mainFrame"> <i
								class="icon-folder-open"></i> <span class="menu-text"> <strong>
										已完成 </strong> </span> </a>
						</div>
					</li>

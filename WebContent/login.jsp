...
<body>
	...
	<div style="width:960px;height:400px;margin:0 auto; margin-left:180px;">
		...
		<table
			style="border-style:dashed;border-width:1px; border-color:#f66;"
			bordercolor="#f66" width="960" height="360" cellpadding="0"
			...
			<tr>
					...
					<div style="border: 1px solid #f66;width:350px;height:250px;">
						<form method="post" name="loginForm2"
							...
							<table align="center" width="340" border="0" height="220"
								...
								<tr>
									<td height="26" colspan="3"><font size="+2" color="#f66"><b>　　　　　会员登录</b> </font>
									</td>
								</tr>
								<tr>
				...
				<td width="518"><font size="-1" color="#777777">成为二手车交易网的会员，您才能竞拍到您看中的车辆，若您还没有二手车交易网的账号，请先<a

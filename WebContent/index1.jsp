...
<body>
	...
	<!-- <div class="menu_navcc">
		<div class="menu_nav clearfix">
			<ul class="nav_content" id="nav">
				...
				<li><a href="vip.html" title="VIP大厅"> <span> VIP大厅 </span> </a>
				</li>
				<li><a href="ypgonggao.html"
					title="预拍公告"> <span> 预拍公告</span> </a>
				</li>
				<li><a href="Notice_front.html" title="帮助中心"> <span>帮助中心
							  </span> </a>
				</li>
	...
	<div class="container" style="margin-left: 180px; clear: both;">
		<c:if test="${sessionScope.user == null }">
			<form method="post" name="loginForm2" action="zlpc/login" onsubmit="return checkForm2()">
				<div class="denglu">
					<div class="tabbox">
						<div class="menu5"></div>
						<div class="con_t1" id="con_one_1">
							<table width="100%" border="0">
								<tr>
									...
									<td><input type="text" name="u_id" class="text2" /></td>
								</tr>
								<tr>
									<td width="60" height="40" align="right">密&nbsp;&nbsp;码&nbsp;</td>
									<td><input type="password" name="psword" class="text2" /></td>
								</tr>
								<tr>
									<td width="60" height="40" align="right">&nbsp;</td>
									<td>
										<div class="c4">
											<input type="submit" value="" class="btn2" /> &nbsp;&nbsp; <a href="login/forget"
												style="font-weight: normal; font-size: 12px; color: #610007"> 忘记密码 </a>
										</div>
									</td>
								</tr>
							</table>
		...
		<DIV class="img_switch">
			<DIV class="img_switch_content" id="pic">
				<a href="#"> <IMG src="VehiclePicture/vcar004.jpg">
				</a> <a href="#"> <IMG src="VehiclePicture/vcar002.jpg">
				</a> <a href="#"> <IMG src="VehiclePicture/vcar003.jpg">
				</a> <a href="#"> <IMG src="VehiclePicture/vcar001.jpg">
				</a> <a href="#"> <IMG src="VehiclePicture/vcar005.jpg">
				</a> <a href="#"> <IMG src="VehiclePicture/vcar006.jpg">
	...
	<div style="height: 170px;">
		<div style="width: 700px; height: 170px; margin-left: 180px; border: 2px solid #f66; float: left;" class="diva">
			<a href="#"><img src="img/auction-flow2.png" style="height: 170px; width: 700px;" /> </a>
		</div>
		<div style="float: left; background: url(img/gonggao.png) no-repeat; width: 300px; height: 170px; left: 884px; position: absolute;">
			<div class="nri">
					...
					<ul>
						<c:forEach var="notice" items="${requestScope.list}">
							<li><div class="test_demo_ellipsis">
									<font size="+1">
										<a href="notice/${notice.n_id }.html" tppabs="#" target="_blank" title="${notice.title}"> ${notice.title}</a>
									</font> 
									<strong>
										【<span class="date" style="font-size: 10px"><fmt:formatDate pattern="yyyy年MM月dd日" value="${notice.n_time }" type="both" /> </span>】
									</strong>
								</div></li>
						</c:forEach>
					</ul>
				...
				<form>
					<table border="0" width="1004px;" cellpadding="0" cellspacing="0">
						<thead>
							...
							<tr>
								<td height="25" colspan="2" bgcolor="#f66"  align="center"><font size="+1">
										竞拍车辆基本信息</font></td>
								<td width="210" height="25" bgcolor="#f66"  align="center">&nbsp;
									&nbsp;&nbsp; 竞拍时间
								</td>
								<td width="78" height="25" bgcolor="#f66"  align="center"><font size="+1">
										竞拍底价 </font><b id="ss_pro__1" class="font14"> <span
										id="img_pro_1"> </span> </b></td>
								<td width="173" height="25" bgcolor="#f66"  align="center"><font size="+1"> 竞拍车辆来源</font>
								</td>
								<td width="245" height="25" bgcolor="#f66"  align="center"> <font size="+1"> 竞拍/购物车</font>
								</td>
							</tr>
						</thead>
							...
							<tbody>
								<tr>
									...
									<td align="center" width="210">
										<div style="font-weight:bold" class="timeCss">开始时间	<br /> &nbsp;&nbsp;&nbsp;&nbsp;

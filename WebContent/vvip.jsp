...
<body>
	...
	<jsp:include page="user_file/vnavi.jsp" flush="true">
		<jsp:param name="vnavIndex" value="3" />
	</jsp:include>
	...
	<div style="height: auto !important; height: 10px; min-height: 10px;">
		<div style="margin-bottom: 5px; border-bottom: solid 1px #c2d5e3; margin-left: 180px; margin-right: 185px;">
			<c:choose>
				...
				<c:otherwise>
					<font size="5" color="red">未完成订单:</font>
													...
													<table>
														<tr>
															<td>
																...
																<form action="cancelindentFinish.html" method="post">
																	<input type="hidden" name="vuser" value="${sessionScope.user.u_id}" /> <input type="hidden" name="v_id"
																		value="<%out.print(index);%>" /> <input type="hidden" name="vstate" value="-2" /> <input type="submit"
																		style="background: url(img/nav_li_hover.gif); width: 60px; height: 30px;" id="auctionExit" value="取消订单" />
															...
															<td>
																<form action="cancelindentFinish.html" method="post">
																	<input type="hidden" name="vuser" value="${sessionScope.user.u_id}" /> <input type="hidden" name="v_id"
																		value="<%out.print(index++);%>" /> <input type="hidden" name="vstate" value="0" /> <input type="submit"
																		style="background: url(img/nav_li_hover.gif); width: 60px; height: 30px;" id="auction" value="处理完成" />
															</td>
														</tr>
														</form>
													</table>
 ...
 --%>
													...
													<form action="cancelindentFinish.html" method="post">
														<input type="hidden" name="vuser" value="${sessionScope.user.u_id}" /> <input type="hidden" name="v_id"
															value="<%out.print(indexFinish++);%>" /> <input type="hidden" name="vstate" value="1" /> 
															<input type="submit" id="auction"
															style="background: url(img/nav_li_hover.gif); width: 60px; height: 30px;"
															value="删除订单" />
													</form>
 ...
 --%>
		...
		<form action="backstage/Vehicle/Vehicle_add.jsp" method="post">
			<input type="submit" id="auction" 
			style="background:url(img/banner4.jpg); width: 300px; height: 70px; text-align: center; font-size: large;" 
			value="发布二手车信息" />
		</form>
	</div>
	<br />

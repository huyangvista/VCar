...
<hr style= "border: 1px dashed #f66" />
<table style="border-style:dashed;border-width:1px; border-color:#f66;" bordercolor="#f66" width="960" height="500" cellpadding="0" cellspacing="0" align="center" >
  <tr>
    <td width="428">
    	<div  style="border: 1px solid #f66;width:400px;height:450px;">
    	  ...
    	  <table align="center" width="420" border="0" height="450" cellpadding="0" cellspacing="0">
    	    <tr>
    	      <td height="26" colspan="3"><font size="+2" color="#f66"><b>　　　　　会员注册</b></font></td>
   	        </tr>
    	    <tr>
    ...
    <td width="530">
    	<font size="-1" color="#777777">成为有二手车交易网的会员，您才能竞拍到您看中的车辆，若您已经拥有二手车交易网的账号，请直接<a href="login.jsp"><font size="+1"><b>登录</b></font></a>账号。</font>    </td>
  </tr>
</table>
</div>

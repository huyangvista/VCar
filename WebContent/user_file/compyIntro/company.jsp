...
<body>
	...
	<jsp:include page="../vnavi.jsp" flush="true" >
	 <jsp:param name="vnavIndex" value="6"/>  
	 </jsp:include>
	<!-- 头部加上导航栏结束-->
		...
		<div id="w970">
			<div class="top3">
				...
				<div id="navi">
					...
					关于我们;&nbsp; <a href="AdminLogin.html">系统</a>
				</div>
			</div>

			<div id="index-k" style="margin-bottom: 5px; border: 1px solid #f66;">
				...
				<div class="con_zh" style="margin-bottom: 0px">
					<div class="contact0" style="height: 150px; *height: 120px;">
						<div class="contact_con">
							...
							<ul>
								<li>公司网站：<a target="_blank" href="http://www.baidu.com">www.baidu.com</a>&nbsp;
								</li>
					...
					<div class="zh">
						<div class="contact_con"
							style="background-image: url(img/zhpic.gif); width: 470px; background-repeat: no-repeat; background-position: right bottom; height: 170px">
				...
				<div class="intro">
					<div
						style="border: 1px solid #f66; margin-left: -30px; margin-top: 10px; width: 490px">
					...
					<div
						...
						<p style="text-align: left">
							<span
								...
								&nbsp;&nbsp;&nbsp;
								二手车交易网依托江西省银海拍卖有限公司共同开发主营事故车拍卖业务，以www.zlpaiche.com为公司发展平台。是国内专业的事故车拍卖平台。同时有事故车、拆车件信息免费发布，维修资料，行业新闻免费查询。是保险公司、4s店、汽修厂、维修行业人员的门户网站。
								二手车交易网以尊客重德、诚信厚道为经营理念；以认真、专业规范为工作理念；以真诚打造放心服务的服务理念；为保险公司和车主提供优质服务。

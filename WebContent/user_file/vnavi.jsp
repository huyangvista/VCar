		...
		<div class="menu_nav clearfix">
			...
			<ul class="nav_content" id="nav">
				<%
					...
					if (vsreq != null)
						vnavIndex = Integer.parseInt(vsreq);
					...
					String[] vnavText = { "首页", "交易大厅", "卖家中心", "会员中心", "帮助中心", "公司简介"/* , "" */ };
					String[] vnavHref = { "index.html", "ypgonggao.html", "vip.html", "user.html", "Notice_front.html","company.html"/* , "paimai.html" */ };

...
<body>
	...
	<div id="main1_x" align="center">
		<div id="w970">
			<%-- <div style="margin-bottom: 5px; border-top: solid 1px #c2d5e3; border-bottom: solid 1px #c2d5e3;" align="left">
				<span id="blacktag">事故车</span> <span style="font-size: 20px; font-weight: bold">${requestScope.list[0].vname }</span>,由${requestScope.list[0].source }提供
				<a href="javascript:setRequest('${sessionScope.user.u_id }','${entry.v_id}','state' , '0')" class="downpic">竞价登记</a> <input
					title="加入购物车，我们的客服会主动与您联系，提供更为细致的服务！" class="button2"
					onClick="javascript:setRequest('${sessionScope.user.u_id }','${requestScope.list[0].v_id}','attention' , '1')" value="加入购物车" type="button" />
				...
				<div id="container">
					<div class="picture-slides-container">
						<div id="div1" style="opacity: 1;" class="picture-slides-fade-container">
							<a class="picture-slides-image-link"> <span style="display: none;" class="picture-slides-image-load-fail">图片加载失败</span> <img title=""
								class="picture-slides-image" src="${image}" alt="" height="487" width="650" id="big" />
							</a>
						</div>
						<div id="div2">
							<ul class="picture-slides-thumbnails">
								<c:forEach var="entry" items="${imageList}">
									<li><img src="${entry}" alt="车辆图片" height="90" width="80" /></li>
								</c:forEach>
								<li><img src="img/nocar.gif" alt="查看更多照片请先注册会员或登陆网站" title="查看更多照片请先注册会员或登陆网站" /></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<table bgcolor="#cccccc" border="0" width="310" cellpadding="0" cellspacing="1">
					<tbody>
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" height="25">${requestScope.list[0].plateNo}</td>
						</tr>
						<tr>
							<td bgcolor="#f7f7f7" height="25">
								<div align="right">
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" height="25" width="155"><strong>公示车辆</strong></td>
						</tr>
						<tr>
							<td bgcolor="#f7f7f7" height="25">
								<div align="right">
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" height="25" width="155">${requestScope.list[0].strfTransfer}</td>
						</tr>
						<tr>
							<td bgcolor="#f7f7f7" height="25">
								<div align="right">
							...
							<td bgcolor="#FFFFFF" height="25" width="155">${requestScope.list[0].strfAgain}</td>
						</tr>
						<tr>
							<td bgcolor="#f7f7f7" height="25">
								<div align="right">
							...
							<td bgcolor="#FFFFFF" height="25" width="155">${requestScope.list[0].strfDisass}</td>
						</tr>
						<tr>
							<td bgcolor="#f7f7f7" height="25">
								<div align="right">
							...
							<td bgcolor="#FFFFFF" height="25" width="155">${requestScope.list[0].strfBRule}</td>
						</tr>
						<tr>
							<td bgcolor="#f7f7f7" height="25">
								<div align="right">
							...
							<td bgcolor="#FFFFFF" height="25" width="155">${requestScope.list[0].strfMort}</td>
						</tr>
						<tr>
							<td bgcolor="#f7f7f7" height="25">
								<div align="right">
						...
						<tr>
							...
							<td style="color: #FF0000" bgcolor="#FFFFFF" height="25" width="155">${requestScope.list[0].note}</td>
						</tr>
						<tr>
							<td bgcolor="#f7f7f7" height="25">
								<div align="right">
			...
			<a href="javascript:setRequest('${sessionScope.user.u_id }','${entry.v_id}','state' , '0')" class="downpic"> </a>
			 <input
				title="加入购物车，我们的客服会主动与您联系，提供更为细致的服务！" class="button2"
				onClick="javascript:setRequest('${sessionScope.user.u_id }','${requestScope.list[0].v_id}','attention' , '1')" 
				
				style="background:url(img/nav_li_hover.gif); width: 100px; height: 30px; text-align: center; font-size: large;"
	...
	<script src=" http://hm.baidu.com/h.js?9f76d5edb5f4d98c9a23c7034c4f8df0" type="text/javascript"></script>
	<div style="display: none;">
		<img src="images/201311219500.jpg" alt="" /> <img src="images/201311219500.jpg" alt="" /> <img src="images/201311219500.jpg" alt="" /> <img
			src="images/201311219500.jpg" alt="" /> <img src="images/201311219500.jpg" alt="" /> <img src="images/201311219500.jpg" alt="" /> <img
			src="images/201311219500.jpg" alt="" /> <img src="images/201311219500.jpg" alt="" /> <img src="images/lnocar.gif" alt="" />
	</div>

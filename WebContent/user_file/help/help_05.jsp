  ...
  <div id="w970">
    ...
    <div style="width: 720px; float: left;">
      <div id="index-k2" style="margin-bottom: 15px">
        <div class="question">
          <h1> <span style="font-size: medium">购买指南</span> </h1>
          <p> <span style="font-size: medium">1、浏览网站车辆公示信息：
            选择您感兴趣的车辆，打开车辆页面，了解参拍车辆公示信息。
            。</span> </p>
          <p> <span style="font-size: medium">2、参拍申请：
            标的车辆图片右侧“您没有参与购买权限”的右侧“点击申请参与购买”，进行申请参拍。申请说明上填写您的姓名、联系电话等，我们会有专人与您联系。</strong> </span> </p>
          <p> <span style="font-size: medium">3、交纳保证金：
            请在购买前提前一小时以上将购买保证金到账，保证金为起拍价的15%。最低5000元，最高30000元（每个车辆公示信息会有说明）。参拍中标后，保证金冻结，可用作手续费扣除。参拍未中标者，会将该保证金退回您在腾信的基金账户中，以备下次购买使用；也可以根据您的要求退回到您银行账户里（需要您主动提出），该退款过程约需三个工作日。
            保证金等相关费用的充值交纳，周一到周五请汇入腾信对公账户，周六银行非对公工作日可汇到腾信私人账户。详见网站的“帮助中心”—“公司账户”。</span> </p>
          <p> <span style="font-size: medium">4、参与购买：
            您在做好参拍申请并获得腾信参拍资格确认后进行出价。
            参拍期间有任何疑问，均可与您所在区域的对应服务专员联系。</span> </p>
          <p> <span style="font-size: medium">5、车辆中标：
            当您参拍车辆且中标后，需要交纳该车购买手续费，要求24小时内到账。购买手续费为中标价的10%，最低1000元，最高30000元。</span> </p>

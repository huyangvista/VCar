  ...
  <div id="w970">
    ...
    <div style="float: left; width: 720px;">
      <div style="width: 720px; float: left;">
        <div id="index-k2" style="margin-bottom: 15px">
          ...
          <div class="question">
            <div class="ques"> <a href="help/2.html">
              <h3> <span style="font-size: medium">2、如何取得购买权限？</span> </h3>
              </a> </div>
          </div>
          <div class="question">
        ...
        <div id="index-k3"
						style="border-bottom: #f66 1px solid; border-left: #f66 1px solid; margin-bottom: 0px; border-top: #f66 1px solid; border-right: #f66 1px solid">
          <div id="bk-b"
							style="filter: alpha(opacity=60); background: #f66; color: white">

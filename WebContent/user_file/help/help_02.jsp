		...
		<div id="w970">
			<div class="top3">
				...
				<div id="index-k2" style="margin-bottom: 15px">
					<div class="question">
						<h1>
							<span style="font-size: medium">问题：如何取得购买权限？</span>
						</h1>
						...
						<p>
							<span style="font-size: medium"><strong>2、在首页中购买车辆公告中点击竞价登记,或在预拍公告中点击竞价登记。</strong>
							</span>
						</p>
						<img style="vertical-align: middle;" src="img/pic1.jpg"><br/><br/>
					
						<p>
							<span style="font-size: medium"><strong>3、竞价登记成功联系右边的客户缴纳保证金等待客户开通竞价购买权限。</strong></span>
						</p>
							<img style="vertical-align: middle;" src="img/pic2.jpg"><br/><br/><br/><br/>
						<p>
							<span style="font-size: medium"><strong>4、权限开通成功可以竞价购买车辆。</strong></span>
						</p>

  ...
  <div id="w970">
    ...
    <div style="width: 720px; float: left;">
      <div id="index-k2" style="margin-bottom: 15px">
        <div class="question">
          <h1> <span style="font-size: medium">问题：购买保证金的缴纳以及退还？</span> </h1>
          <p> <span style="font-size: medium">1竞价保证金：
            为了更好的体现公开公平的网络竞价环境，我们要求所有意向参加车辆竞价的用户都需要缴纳足额的保证金才可以参加网络竞价。我们会根据车辆的底价不同制定该车的保证金金额，保证金金额为购买底价的15%。最低5000，当竞价结束后，如果您的出价不是最高出价，未成交的话，则保证金会在2小时之内退回您的账户。</span> </p>
          <p> <span style="font-size: medium">2、维修时效保证金：<br />
            ：
            对用户的一种约束措施。本站在竞价公告中会明确说明，该车的维修过户时间，为了更好的体现公开公平的网络竞价环境，更好的约束用户遵守购买规则。所有参加网络竞价并最终成交的用户，需要缴纳的维修时效保证金，作为对维修过户时间的保证。 </span> </p>
          ...
          <p> <span style="font-size: medium">5、协助提车费用：<br />
            为提高工作效率，规范化工作流程，二手车交易网将后续为成交车辆业务人员协助提车，所需的费用由竞买人承担，具体收费标准咨询客服：</span> </p>

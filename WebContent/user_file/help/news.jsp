...
<body>
	...
	<jsp:include page="../vnavi.jsp" flush="true">
		<jsp:param name="vnavIndex" value="5" />
	</jsp:include>
	<!--头部结束-->
	<div id="main1_x">
		<div id="w970">
			<div class="top3">
				<div class="top4">
					...
					显示公告 <img style="vertical-align: middle;" src="img/1250(1).jpg" tppabs="http://www.cygpm.com/images/1250.gif"> <a href="index.jsp">返回首页</a>
				</div>
				<div id="navi">
					首页&nbsp; <img style="vertical-align: middle;" src="img/1250(1).jpg" tppabs="http://www.cygpm.com/images/1250.gif"> &nbsp; 帮助中心 
				</div>
			</div>
			...
			<div style="width: 720px; float: left;">
				<div id="index-k2" style="margin-bottom: 15px">
					<div class="question">
						<c:forEach var="announce" varStatus="st" items="${requestScope.list1}">
							<table class="news" width="690px">

								<tr>
									<td align="center"><h2>
											<font size="5">${announce.title}</font>
										</h2></td>
								...
								<tr>
									<td align="center"><span class="date"><fmt:formatDate pattern="yyyy年MM月dd日" value="${announce.n_time }" type="both" /></span></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
								...
								<tr>
									<td align="right"><font color="#F00">二手车交易网</font></td>

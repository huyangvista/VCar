 ...
 --%>
				...
				<div align="center">
					<%-- <ul class="pagination">
						...
						<li><a href="query/DealVehicle_${sessionScope.user.u_id }&skip=1">首页</a></li>
						<li><a href="query/DealVehicle_${sessionScope.user.u_id }&skip=${page.page-1<=1?1:page.page- 1}"> 上一页 </a></li>
						<li><a href="query/DealVehicle_${sessionScope.user.u_id }&skip=${page.page + 1 >=page.lastPage?page.lastPage:page.page + 1}"> 下一页</a></li>
						<li><a href="query/DealVehicle_${sessionScope.user.u_id }&skip=${page.lastPage}"> 末页</a></li>
					</ul> --%>
				</div>
				<ul class="jingjia">
					<li></li>
